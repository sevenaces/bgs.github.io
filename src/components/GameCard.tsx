...
export function GameCard({ game }: GameCardProps) {
  ...
  return (
    <div
      ...
      className="bg-white rounded-xl border border-neutral-200 overflow-hidden hover:border-neutral-300 hover:shadow-xs transition-all flex flex-col justify-between group"
    >
      <div>
        {/* Thumbnail / Image */}
        ...
        <div className="p-3.5 space-y-2">
          <div className="flex items-start justify-between gap-2">
            <h3
              className="text-sm font-bold text-neutral-900 tracking-tight line-clamp-1"
              title={game.name}
            >
              {game.name}
            </h3>
      ...
      <div className="p-3.5 pt-0">
        <a
          ...
          className="w-full flex items-center justify-center gap-1.5 py-2 px-3 bg-neutral-50 hover:bg-neutral-100 text-neutral-800 hover:text-neutral-900 border border-neutral-200 rounded-lg text-xs font-semibold transition-colors shadow-2xs"
        >
